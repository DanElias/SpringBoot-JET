package com.danelias.jdbc;

import com.danelias.jdbc.util.DataAccessObject;
...
public class OrderDAO extends DataAccessObject<Order> {
    ...
    private static final String GET_FOR_CUST= "SELECT * FROM get_orders_by_customer(?)"; //Intermediate table from stored procedure
